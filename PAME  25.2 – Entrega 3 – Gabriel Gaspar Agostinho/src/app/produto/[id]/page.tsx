...
export default async function ProdutoPage({ params }: ProdutoPageProps) {
    ...
    // ESPERAR OS PARÂMETROS CARREGAREM
    ...
    return (
        <div className="pb-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="flex flex-col h-full justify-center">
                        ...
                        */}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-8">
                            ...
                            <button className="px-6 py-4 rounded-xl border border-mocha/20 text-mocha font-bold hover:bg-soft-white transition active:scale-95">
                                ♥
                            </button>
                        </div>
